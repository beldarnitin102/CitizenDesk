    ...
    <Card className="rounded-3xl p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-slate-500">{complaint.complaintNumber}</p>
        </div>
      ...
      <div className="mt-8 grid gap-6 md:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-2">{complaint.category}</p>
        </div>
        ...
        <div>
          <h3 className="font-semibold">Assigned Employee</h3>

          <p>{complaint.assignedEmployee?.name || "Not Assigned"}</p>
        </div>
