...
function Hero() {
  return (
    <Section className="relative overflow-hidden bg-gradient-to-b from-white via-slate-50 to-white pt-24 lg:pt-28 " >
     ...
     <div className="grid min-h-[620px] items-center gap-12 lg:grid-cols-[1fr_1.15fr]">
        <HeroContent />
        <HeroVisual />
      </div>
